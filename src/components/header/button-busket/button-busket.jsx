...
import s from './index-button-busket.module.scss'

export class ButtonBusket extends Component {
    onClick() {
        console.log("Открывает корзину")
    }
    render() {
        return (
            <button className={s.btn} onClick={this.onClick}>
